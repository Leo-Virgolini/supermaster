...
@NoArgsConstructor
@Entity
@Table(name = "clasif_gral", schema = "supermaster",
        uniqueConstraints = @UniqueConstraint(name = "uk_clasif_gral_nombre_padre", columnNames = {"nombre", "id_padre"}))
public class ClasifGral {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_clasif_gral", nullable = false)
    private Integer id;
    ...
    private ClasifGral padre;

    @OneToMany(mappedBy = "padre")
    private Set<ClasifGral> subclasificaciones = new LinkedHashSet<>();
