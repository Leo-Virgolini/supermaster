...
public record ConceptoCalculoUpdateDTO(
        ...
        @Pattern(regexp = "GASTO_SOBRE_COSTO|FLAG_FINANCIACION_PROVEEDOR|AJUSTE_MARGEN_PUNTOS|AJUSTE_MARGEN_PROPORCIONAL|FLAG_USAR_MARGEN_MINORISTA|FLAG_USAR_MARGEN_MAYORISTA|GASTO_POST_GANANCIA|FLAG_APLICAR_IVA|IMPUESTO_ADICIONAL|GASTO_POST_IMPUESTOS|FLAG_INCLUIR_ENVIO|COMISION_SOBRE_PVP|FLAG_COMISION_ML|FLAG_INFLACION_ML|INFLACION_SOBRE_PVP|CALCULO_SOBRE_CANAL_BASE|CALCULO_SOBRE_CANAL_BASE_RESELLER|RECARGO_CUPON|DESCUENTO_PORCENTUAL|INFLACION_DIVISOR|GASTO_FUERA_PVP|FLAG_APLICAR_PRECIO_INFLADO",
                message = "aplicaSobre debe ser uno de los valores válidos del enum AplicaSobre")
        String aplicaSobre,
        @Pattern(regexp = "COSTO_PRODUCTO|COSTO_VENTA|IMPUESTO|MARKUP|INFLACION|DESCUENTO|BASE|COSMETICO",
                message = "naturaleza debe ser uno de los valores válidos del enum NaturalezaConcepto")
        String naturaleza,
