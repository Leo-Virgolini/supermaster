...
function GroupTitle({ children }: { children: React.ReactNode }) {
    return <h3 className="mb-2 text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">{children}</h3>;
}
...
export default function ProductosFilterPanel({ filters, filterValueLabels, onFilterChange, onClearAll, activeCount }: PanelProps) {
    ...
    return (
        <div className="shrink-0 space-y-4 border-b border-gray-200 bg-gray-50/60 px-4 py-4 dark:border-slate-700 dark:bg-slate-800/40">
            <div>
